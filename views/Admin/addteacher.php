    ...
    <div class="w-[100vw] h-[100vh] md:flex gap-4">
            ...
            <div class="">
             ...
             <div class="">
                 <div class="flex gap-2 items-center justify-center">
                     ...
                     <a href="../Admin/admin-dashboard.php" class="text-3xl font-[500] text-white">Dashboard</a>
                 ...
                 <div class="">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                         <div class="flex gap-2 justify-center items-center hover:font-[700] hover:text-lg" style="display: none;" id="add">
                             ...
                             <a class=" text-white -mt-8" href="../Admin/addteacher.php">Add Teacher</a>
                        </div>
                        <div class="flex justify-center gap-2 items-center hover:font-[700] hover:text-lg ml-10" style="display: none;" id="view">
                         ...
                         <a class=" text-white -mt-8" href="../Admin/viewteacher.php">View all Teachers</a>
                 ...
                 <div class="">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                         <div class="flex gap-2 justify-center items-center hover:font-[700] hover:text-lg" style="display: none;" id="guard">
                             <b class="text-4xl text-white font-[700]">∙</b>
                             <a class=" text-white -mt-8" href="../Admin/addguardian.php">Add Guardian</a>
                        </div>
                     </div>
                 </div><br>
                 ...
                 <div class="">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                        ...
                        <div class="flex justify-center gap-2 items-center hover:font-[700] hover:text-lg ml-8" style="display: none;" id="viewStudent">
                           <b class="text-4xl mt-10 text-white font-[700]">∙</b>
                           <a class=" text-white -mt-8" href="../Admin/view-all-student.php">View all Students</a>   
                        </div>
                     </div>
                 </div><br>
        ...
        <div class="lg:w-[78vw] w-[100vw] h-[950px] md:h-[100vh] md:pt-4">
            ...
            <div class=" md:w-[78vw] h-[630px] rounded-br-lg rounded-bl-lg bg-white md:shadow-2xl md:pl-12 md:px-0 px-4" id="mainpage">
                ...
                <h1 class="font-[700] text-3xl ml-10 pt-10">Add Teacher</h1><br><br><br class="hidden md:block">
              <div class="md:flex md:gap-6">

                <form action="../../controllers/addteacher.php" method="post" class="md:w-[50vw] md:pr-6">
                    <div class="md:flex gap-10">
                       ...
                       <div class="">
                           ...
                           <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="surname" id="" placeholder="Enter Surname">
                       </div>
                   </div><br>
                   ...
                   <div class="md:flex gap-10">
                       <div class="">
                           <div class="flex gap-[2px] items-center">
                               ...
                               <label class="text-lg font-[500]" for="">Phone Number</label>
                            </div>
                            <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="phoneNumber" id="" placeholder="Phone Number">
                       </div><br class="md:hidden">
        
                       <div class="">
                           <div class="flex gap-[3px] items-center">
                               <img class="w-[20px] h-[20px]" src="../../Helpers/asset/mail.png" alt="user">
                               <label class="text-lg font-[500]" for="">Email Address</label>
                           </div>
                           <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="email" name="email" id="" placeholder="Email Address">
                       </div>
                    </div><br>
                    ...
                    <div class="md:flex gap-10">
                       ...
                       <div class="">
                           <div class="flex gap-[2px] items-center">
                            ...
                            <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="homeAddress" id="" placeholder="Home Address">
                       </div>
                    </div><br>
                   ...
                   <button type="submit" name="save" class="text-xl text-white rounded-lg shadow-xl mt-10 font-[600] md:ml-[30vw] mx-[20vw] border-2 w-[200px] h-[50px] bg-[#F97903]">Save</button>
               </form>
