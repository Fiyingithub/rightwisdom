    ...
    <div class="w-[100vw] h-[100vh] md:flex gap-4">
        ...
        <div class="lg:w-[78vw] w-[100vw] h-[950px] md:h-[100vh] md:pt-4">
            ...
            <div class=" md:w-[78vw] h-[630px] rounded-br-lg rounded-bl-lg bg-white md:shadow-2xl md:pl-12 md:px-0 px-4" id="mainpage">
                ...
                <h1 class="font-[700] text-3xl ml-10 pt-10">Add Guardian</h1><br><br><br class="hidden md:block">
              <div class="md:flex md:gap-6">
                <form action="" class="md:w-[50vw] md:pr-6">
                    <div class="md:flex gap-10">
                        <div class="">
                           ...
                           <input class="w-[100%] md:w-[23vw] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="" id="" placeholder="Enter Firstname">
                       </div><br class="md:hidden">
        
                       <div class="">
                           <div class="flex items-center">
                               <img class="w-[20px] h-[20px]" src="../../Helpers/asset/user (2).png" alt="user">
                               <label class="text-lg font-[500]" for="">Lastname</label>
                           </div>
                           <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="" id="" placeholder="Enter Lastname">
                       </div>
                   </div><br>
                   ...
                   <div class="md:flex gap-10">
                       <div class="">
                           <div class="flex gap-[2px] items-center">
                            ...
                            <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="text" name="" id="" placeholder="Phone Number">
                       </div><br class="md:hidden">
                       ...
                       <div class="">
                           ...
                           <input required class="md:w-[23vw] w-[100%] pl-4 h-[50px] border-2 border-gray-400 focus:outline-[#F97903] rounded-lg" type="email" name="" id="" placeholder="Email Address">
                       </div>
                    </div><br>
                   ...
                   <button class="text-xl text-white rounded-lg shadow-xl mt-10 font-[600] md:ml-[30vw] mx-[20vw] border-2 w-[200px] h-[50px] bg-[#F97903]">Save</button>
               </form>
