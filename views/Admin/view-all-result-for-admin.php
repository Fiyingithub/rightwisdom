...
<body class="md:bg-[#F9C18E] bg-white">
    <div class="w-[100vw] h-[100vh] md:flex gap-4">
            ...
            <div class="">
             ...
             <div class="">
                 <div class="flex gap-2 items-center justify-center">
                     ...
                     <a href="admin-dashboard.html" class="text-3xl font-[500] text-white">Dashboard</a>
                 ...
                 <div class="">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                        ...
                        <div class="flex justify-center gap-2 items-center hover:font-[700] hover:text-lg ml-10" style="display: none;" id="view">
                         ...
                         <a class=" text-white -mt-8" href="viewteacher.html">View all Teachers</a>
                 ...
                 <div class="">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                         <div class="flex gap-2 justify-center items-center hover:font-[700] hover:text-lg" style="display: none;" id="guard">
                             <b class="text-4xl text-white font-[700]">∙</b>
                             <a class=" text-white -mt-8" href="addguardian.html">Add Guardian</a>
                        </div>
                     </div>
                 </div><br>
                 ...
                 <div class="">
                     <div class="flex gap-2 justify-center items-center cursor-pointer">
                         <img class="w-6 h-6" src="../../Helpers/asset/scholar.png" alt="dashboard-image">
                     ...
                     <div class="text-xl font-[500] mt-[10px]">
                        ...
                        <div class="flex justify-center gap-2 items-center hover:font-[700] hover:text-lg ml-8" style="display: none;" id="viewStudent">
                           <b class="text-4xl mt-10 text-white font-[700]">∙</b>
                           <a class=" text-white -mt-8" href="view-all-student.html">View all Students</a>   
                        </div>
                     </div>
                 </div><br>
                 ...
                 <div class="flex justify-center ml-[-70px] gap-2 items-center">
                     ...
                     <a href="../Admin/logout.php" class="text-white  hover:font-[700] hover:text-xl font-[700]">Logout</a>
                 </div>
             </div>
         </div>
        ...
        <div class="lg:w-[78vw] w-[100vw] h-[100%] md:h-[100vh] md:pt-4">
            <div class="md:w-[78vw] w-[100vw] md:h-[70px] h-[80px] md:pl-8 md:px-0 px-4 md:gap-12 gap-4 flex  items-center md:rounded-md bg-[white] md:shadow-md" id="navbar">
                ...
                <div class="flex mx-[20vw] md:mx-0 md:gap-1">
                    ...
                    <h1 class="md:text-xl text-3xl font-[700]">Teacher</h1>
                </div>
            ...
            <div class=" md:w-[78vw] md:h-[630px] h-[400px] rounded-br-lg rounded-bl-lg bg-white md:shadow-2xl pt-10 md:pl-8 md:px-0 px-4" id="mainpage">
                <div class="">
                    <div class="">
                        <h1 class="md:text-4xl text-2xl font-[700] md:text-center mb-6">Student Result</h1><br>
                        ...
                        <div class="md:hidden flex md:gap-4 items-center w-[100%] md:w-[45vw] h-[50px] mb-6 border-2 border-[#F97903] rounded-[25px] shadow-md">
                            ...
                            <img class="w-4 h-4 mx-4 md:mr-0 cursor-pointer" src="../../Helpers/asset/search.png" alt="search">
                        </div>

                        <div class="max-h-[450px] overflow-auto">
                            <table border="2" class="border-2 border-black  mx-[auto] text-[17px] ">
                                <tr  style="position: sticky; transition: ease; top: 0; z-index: 1;background-color: white;">
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2 "  >StudentId</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2 "  >StudentName</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2">Class</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2 py-2">Result</th>
                                    
                                </tr>
                         
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">001</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Fowora Taiwo</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">SS1</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]"><a class="text-blue-600 font-[600]" href="student-result.html">View Result</a></td>
                                </tr>
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">002</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Adetona Ridwan</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">SS1</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]"><a class="text-blue-600 font-[600]" href="student-result.html">View Result</a></td>
                                </tr>
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">003</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Adewuyi Faisal</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">SS1</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]"><a class="text-blue-600 font-[600]" href="student-result.html">View Result</a></td>
                                </tr>
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">004</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Isreal Oluchi</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">SS1</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]"><a class="text-blue-600 font-[600]" href="student-result.html">View Result</a></td>
                                </tr>
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">005</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Adebanjo Ayomide</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">SS1</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]"><a class="text-blue-600 font-[600]" href="student-result.html">View Result</a></td>
                                </tr>
