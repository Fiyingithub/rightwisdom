        ...
        <div class="lg:w-[78vw] w-[100vw] h-[100%] md:h-[100vh] md:pt-4">
            <div class="md:w-[78vw] w-[100vw] md:h-[70px] h-[80px] md:pl-8 md:px-0 px-4 md:gap-12 gap-4 flex  items-center md:rounded-md bg-[white] md:shadow-md" id="navbar">
                ...
                <div class="flex mx-[20vw] md:mx-0 md:gap-1">
                    ...
                    <h1 class="md:text-xl text-3xl font-[700]">Student</h1>
                </div>
                        ...
                        <div class="max-h-[450px] overflow-auto">
                            <table border="2" class="border-2 border-black  mx-[auto] text-[17px] ">
                                <tr  style="position: sticky; transition: ease; top: 0; z-index: 1;background-color: white;">
                                    ...
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2 "  >Subject</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2">Session</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20 pr-2 py-2">C/A</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20" >Exam</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20" >Total</th>
                                    <th class="border-black border-2  text-center pl-4 md:pr-20" >Remark</th>
                                </tr>
                         
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">001</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Mathematics</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">First Term</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]">30</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">50</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">80</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Excellent</td>
                                </tr>
                                <tr>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">002</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">English</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">First Term</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]">30</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">50</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">80</td>
                                ...
                                <tr>
                                    ...
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Physics</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">First Term</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]">30</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">50</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">80</td>
                                ...
                                <tr>
                                    ...
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Chemistry</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">First Term</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]">30</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">50</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">80</td>
                                ...
                                <tr>
                                    ...
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">Biology</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">First Term</td>
                                    <td class="border-2 border-black text-center  py-4 text-[15px]">30</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">50</td>
                                    <td class="border-2 border-black text-center  py-2 text-[15px]">80</td>
