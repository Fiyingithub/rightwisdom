                        ...
                        <div class="max-h-[450px] overflow-auto">
                            <table class=" border-collapse  mx-[auto] text-[17px] ">
                                <tr  style="position: sticky; transition: ease; top: 0; z-index: 1;background-color: white;">
                                    ...
                                    <th  class="border md:pr-10 pr-2"style="border-left: none; border-right: none; ">Lastname</th>
                                    ...
                                    <th class="border md:pr-" style="border-left: none; border-right: none;">Guardian-Fullname</th>

                                    <th class="hidden md:block border py-2 pr-10"style="border-left: none; border-right: none;">Home Address</th>
                                </tr>

                                <?php
                                    include "../../controllers/connection.php";
                                    // $query="SELECT * FROM admin_addteacher WHERE email='$email'";   
                                    $query="SELECT * FROM teacher_addstudent";
                                    $result = mysqli_query($conn,$query);
                                    $row = mysqli_num_rows($result);
                                    if($row > 0){
                                        while($data=mysqli_fetch_assoc($result)){
                                            echo "<tr>";
                                            echo "<td>".$data['rollnum']."</td>";
                                            echo "<td>".$data['firstname']."</td>";
                                            echo "<td>".$data['surname']."</td>";
                                            echo "<td>".$data['age']."</td>";
                                            echo "<td>".$data['class']."</td>";
                                            echo "<td>".$data['guardianFullname']."</td>";
